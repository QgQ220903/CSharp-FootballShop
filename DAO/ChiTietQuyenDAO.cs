    ...
    public class ChiTietQuyenDAO : DatabaseAccess
    {
        ...
        public List<ChiTietQuyen> LayDanhSachChiTietQuyen()
        {
            ...
            try
            {
                ...
                command.CommandText = "SELECT * FROM ChiTietQuyen";
        ...
        public List<ChiTietQuyen> TimKiemChiTietQuyen(int maNhomQuyen)
        {
            List<ChiTietQuyen> dt = new List<ChiTietQuyen>();
            string sql = "select * from ChiTietQuyen where MaNhomQuyen = @MaNhomQuyen";
            OpenConnection();
        ...
        // Xóa chi tiết quyền có mã nhóm quyền là ...
        public bool XoaToanBoChiTietQuyen(int maNhomQuyen)
        {
            OpenConnection();
            string sql = "delete ChiTietQuyen where MaNhomQuyen=@MaNhomQuyen";
            command = new SqlCommand(sql, conn);
            command.Parameters.Add("@MaNhomQuyen", SqlDbType.Int).Value = maNhomQuyen;
            int n = command.ExecuteNonQuery();
            CloseConnection();
